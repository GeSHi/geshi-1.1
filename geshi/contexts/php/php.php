...
$this->_childContexts = array(
    ...
    new GeSHiPHPDoubleStringContext('php/heredoc'),
    ...
    // doxygen comments
    new GeSHiContext('php/doxygen', 'doxygen', array(), null, true)
);
 ...
 * is being built for.
 * Of course, what you can put in the URL
 * section is simply the string
 */
